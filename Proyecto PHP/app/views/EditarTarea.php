            ...
            <p><label> Provincia 
                    <select name="provincia">
                        ...
                        foreach ($provincias as $reg):
                            ?>
                            <option value="<?= $reg['cod'] ?>" <?php if (!empty($errores_editar) && $reg['cod'] == $campos['provincia']) { ?> selected <?php } elseif ($reg['cod'] == $datosTarea['provincia']) { ?>selected<?php } ?>><?= $reg['nombre'] ?></option>
                            <?php
                        endforeach;
                        ?>
                    </select>
